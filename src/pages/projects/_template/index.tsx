          ...
          <div className="md:col-span-2 space-y-8">
            ...
            <div>
              ...
              {projectData.overview.paragraphs.map((para, i) => (
                <p key={i} className="text-slate-900 dark:text-slate-100 leading-relaxed mb-4">
                  {para}
                </p>
              ))}
            </div>
            ...
            <div>
              ...
              {projectData.media.demoVideo.url ? (
                <div className="mb-6">
                  ...
                  <p className="text-sm text-slate-900 dark:text-slate-100 text-center">
                ...
                {projectData.media.images.map((img, idx) => (
                  img.url ? (
                    ...
                    <div key={idx} className="aspect-video bg-slate-200 dark:bg-slate-800 rounded-lg flex items-center justify-center">
                      <p className="text-slate-600 dark:text-slate-200 text-sm text-center px-4">
                        {img.caption}
                      </p>
                    </div>
                  )
